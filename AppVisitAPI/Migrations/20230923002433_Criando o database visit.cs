...
{
    /// <inheritdoc />
    public partial class Criandoodatabasevisit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lugares_Arquivos_ArquivoId",
                        column: x => x.ArquivoId,
                        principalTable: "Arquivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Lugares_Cidades_CidadeId",
                        column: x => x.CidadeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lugares_ArquivoId",
                table: "Lugares",
                column: "ArquivoId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Lugares_CidadeId",
                table: "Lugares",
                column: "CidadeId");
        }
